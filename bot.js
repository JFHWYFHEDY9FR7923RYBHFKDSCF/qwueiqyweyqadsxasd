...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    if( msg.toLowerCase().startsWith( prefix + 'ازلة رتبة' ) ){
...
if(member.user.bot) {
channel.send(`${member} ولكم نورت سيرفرنا المحترم`)
}
})
